...
\item {Built a Python/Streamlit RAG application for grounded question answering across local PDF collections.}
% bullet-id: retrieval-pipeline
% bullet-skills: LangChain, FAISS, Google Generative AI Embeddings, Text Chunking
\item {Chunked PDFs into 1,000-character windows with 200-character overlap and indexed Google embeddings in FAISS.}
% bullet-id: grounded-generation
% bullet-skills: Retrieval, LangChain, Groq, Llama 3, Prompt Engineering
\item {Grounded Groq-hosted Llama 3 responses in FAISS-retrieved document context through a retrieval chain.}
% bullet-id: interactive-workflow
% bullet-skills: Streamlit, State Management, Performance Measurement, User Experience
\item {Cached document embeddings in Streamlit session state to accelerate repeated queries and inspect response latency.}
\resumeItemListEnd
\vspace{-2mm}
